...
export interface Dictionary {
  ...
  settings: {
    ...
    knowledgeQuestionPlaceholder: string;
    knowledgeAnswer: string;
    knowledgeAnswerPlaceholder: string;
    knowledgeTags: string;
    knowledgeTagsPlaceholder: string;
    knowledgeTagsHint: string;
    knowledgeAdd: string;
    knowledgeAdding: string;
    knowledgeSave: string;
    knowledgeSaving: string;
    knowledgeCancel: string;
    knowledgeEdit: string;
    knowledgeDelete: string;
    knowledgeDeleteTitle: string;
    knowledgeDeleteBody: string;
    knowledgeDeleting: string;
    knowledgeCreated: string;
    knowledgeUpdated: string;
    knowledgeDeleted: string;
    knowledgeIncomplete: string;
    knowledgeCount: string;
    knowledgeSource: string;
    knowledgeFilter: string;
    knowledgeNoMatches: string;
    saveButton: string;
    savedToast: string;
